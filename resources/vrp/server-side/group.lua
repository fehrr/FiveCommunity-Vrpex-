...
--         for index in pairs(data.groups) do
--             if index == "developerlotusgroup@445" or index == "developer" or index == "developeroff" or index == "admin" or index == "adminoff" or index == "moderador" or index == "moderadoroff" or index == "suporte" or index == "suporteoff" then
--                 --vRP.log("logs/groups/"..os.date("%d-%m-%Hh")..".txt", "Grupo: "..index.." User_id: ".. user_id .. " Resource: ".. GetInvokingResource())
--             end
--         end
...
-- function vRP.addUserGroup(user_id, group, dkey)
...
--             --if gtype == "org" then
--                 --exports.novat_system:SetPlayerNovatMode(player, user_id, false)
--             --end
