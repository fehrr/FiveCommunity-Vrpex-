...
function tvRP.openOrgMenu()
    ...
    if vRP.hasPermission(user_id, "perm.policia") or vRP.hasPermission(user_id,"perm.policiacivil") or vRP.hasPermission(user_id,"perm.core") or vRP.hasPermission(user_id,"perm.policiafederal") then
