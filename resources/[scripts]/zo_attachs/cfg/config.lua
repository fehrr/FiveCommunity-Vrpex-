...
comandos = {
  { comando = "attachs2", perms = { "developer.permissao", "gold.permissao", "bronze.permissao", "perm.booster", "policia.permissao", "suporte.permissao", "perm.attachs", "perm.vipsaojoao" } },
