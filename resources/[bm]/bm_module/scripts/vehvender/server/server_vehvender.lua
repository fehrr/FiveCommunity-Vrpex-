function RegisterTunnel.requestVehInfos(info, data)
    ...
    if info == "sell" then
        ...
        if status then
            ...
            local maxCars, totalCars = exports["bm_module"]:getUserAmountCars(nuser_id)
            ...
            vRP.sendLog("https://discord.com/api/webhooks/1113105700554555456/2CGLjVoxPv3hjFaC5ZGYdJ_U_Lc4Y6h0I70wbdRLxdit-9HleHNnLRgsvH4etnDC2LLG", "[COMPROU] " ..nuser_id.. " | [VENDEU] "..user_id.." | VALOR "..price.." | VEICULO: "..vehName.."")
