    ...
    if user_id then
        ...
        if vRP.hasPermission(user_id, callsConfig.main['permission']) then
            ...
            if #tops > 0 then
                ...
                sendToDiscord("https://discord.com/api/webhooks/1107090182697652224/iJuQ33O5ftdFvOs6OPXjdfuP-hFoWRb3KvkHnt_6ubgs3MUOSyrbNEeE03btCIXhMLGn", { { ["color"] = 6356736, ["title"] = "** Sistema de Chamados **", ["description"] = "\n**TOP LIST:**".. t, ["footer"] = { ["text"] = "© Mirt1n Store", }, } })
